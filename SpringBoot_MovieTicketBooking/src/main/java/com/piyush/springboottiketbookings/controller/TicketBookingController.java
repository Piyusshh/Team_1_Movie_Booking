...
import com.piyush.springboottiketbookings.DAO.BookingsDAO;
import com.piyush.springboottiketbookings.DAO.CityDAO;
import com.piyush.springboottiketbookings.DAO.MovieDAO;
import com.piyush.springboottiketbookings.DAO.ShowDAO;
import com.piyush.springboottiketbookings.DAO.TheaterDAO;
...
//	get City by particular ID
	...
	public ResponseEntity<City> getOneCity(@PathVariable(value="ID") long ID){
		...
		{
			try {
				System.out.println("coming to try");
				throw new ProductNotfoundException();
			}
			catch(ProductNotfoundException p)
			{
				System.out.println("coming to catch");
				return ResponseEntity.ok().body(p.cityCheck());
			}
		}
		return ResponseEntity.ok().body(theCityDAO.findOne(ID));
